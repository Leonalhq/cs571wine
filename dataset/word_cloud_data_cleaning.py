...
fruit_purple = {"citrus", "grapefruit", "lemon", "berry", "blackberry", 
          ...
          "banana", "strawberry", "jam", "raisin", "prune", 'cherries', 'fruits', 'pinot',
          'pear', 'lime', 'plum', 'currants', 'raspberries' ,'tangerine', 'fruity', 'grape', 
          'cranberry', 'blackberries', 'napa', 'gooseberry', 'blueberry', 'grapes'}  

spice_orange = {"spice", "aromas", "spicy", "licorice", "anise", "black", "pepper cloves" , 
                'spices', 'cassis', 'peppery', 'cinnamon'} 
...
earthy = {"moldy", "earthy", "mushroom", "dusty", 'earth'} 
...
import json
with open('Portugal.json', 'w') as json_file: 
